...
| \(\ln \Delta\)    | \(\ln(\Delta) = \ln\!\Big(\sqrt{(y_a - y_b)^2 + (\phi_a - \phi_b)^2}\Big)\) | Logarithm of angular separation between particles |
| \(k_T\)           | \(k_T = \min(p_{T,a}, p_{T,b})\,\Delta\)                              | Transverse momentum scale (soft / collinear observable) |
| \(\ln k_T\)       | \(\ln(k_T) = \ln\!\big(\min(p_{T,a}, p_{T,b})\,\Delta\big)\)          | Logarithm of transverse momentum scale      |
| \(z\)             | \(z = \frac{\min(p_{T,a}, p_{T,b})}{p_{T,a} + p_{T,b}}\)                | Momentum fraction (energy‑sharing parameter) |
| \(\ln z\)         | \(\ln(z) = \ln\!\Big(\frac{\min(p_{T,a}, p_{T,b})}{p_{T,a} + p_{T,b}}\Big)\) | Logarithm of momentum fraction             |
| \(m^2\)           | \(m^2 = (E_a + E_b)^2 - \|\mathbf p_a + \mathbf p_b\|^2\)             | Squared invariant mass of the particle pair |
| \(\ln m^2\)       | \(\ln(m^2) = \ln\!\Big((E_a + E_b)^2 - \|\mathbf p_a + \mathbf p_b\|^2\Big)\) | Logarithm of the squared invariant mass     |
...
- \(\mathbf p_i = (p_{x,i},\,p_{y,i},\,p_{z,i})\) is the momentum 3‑vector of particle \(i\)  
