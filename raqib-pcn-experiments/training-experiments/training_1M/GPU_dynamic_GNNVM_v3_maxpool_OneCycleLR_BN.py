...
class Classifier(torch.nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        ...
        self.bn_conv1 = nn.BatchNorm1d(4)  # Batch norm for 1D conv (4 channels)
        self.conv1d_2 = torch.nn.Conv1d(in_channels=4, out_channels=4, kernel_size=3, padding=1)
        self.bn_conv2 = nn.BatchNorm1d(4)  # Batch norm for 1D conv (4 channels)
    ...
    def forward(self, x):
        ...
        # Apply 1D convolutions along feature dimension with batch normalization
...
wandb.config.update({
    ...
    "architecture_type": "matrix_based_conv_max_pooling_with_OneCycleLR_and_BN",
    ...
    "batch_normalization": "applied_to_all_layers"
})
