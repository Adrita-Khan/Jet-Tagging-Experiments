...
parser.add_argument('--model_architecture', type=str, default=f'PCN-{batch_size}-ReduceLROnPlateau-BN', help='Model architecture name (default: PCN)')
...
class GNNFeatureExtractor(nn.Module):
    def __init__(self, in_feats, hidden_feats, k):
        ...
        # BatchNorm layers for node feature normalization after each conv (user style names)
...
wandb.config.update({
    ...
    "architecture_type": "1x1_conv_with_ReduceLROnPlateau_scheduler_BN",
