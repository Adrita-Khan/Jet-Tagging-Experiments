...
for epoch in range(maxEpochs):
    ...
    "GPU Memory Used (GB)": gpu_mem_used_gb,
...
# Make sure the metrics directory exists
...
# Modified section to handle both training and testing mode
try:
    if maxEpochs != 0:
        # Training mode - works with tensor lists
